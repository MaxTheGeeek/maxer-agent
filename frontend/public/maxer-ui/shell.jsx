...
function LiveBrain({ state = 'scan', size = 56, label = true }) {
  const palette = {
...
function MatchMeter({ score, size = 64, breakdown }) {
  const r = size / 2 - 4;
  const c = 2 * Math.PI * r;
...
// ─── Distance pill ─────────────────────────────────────────────
function DistancePill({ km, max = 70 }) {
...
// ─── Tooltip ──────────────────────────────────────────────────
function Tooltip({ children, text, width = 280 }) {
...
// ─── Severity dot ──────────────────────────────────────────────
function SeverityDot({ level, size = 8 }) {
...
// ─── Section/card chrome ──────────────────────────────────────
function Card({ children, style, padding = 18, span, accent = false }) {
  return (
    <div style={{
...
// ─── Toolbar buttons ──────────────────────────────────────────
function TBtn({ children, onClick, primary, danger, disabled, size = 'md', style }) {
...
Object.assign(window, { AppContext, useApp, LiveBrain, MatchMeter, StackBadge, DistancePill, Tooltip, SeverityDot, Card, CardHead, TBtn });
